    ...
    <LandingWrapper>
      ...
      <RightSection>
        ...
        <BodyText>
          ...
          a site slicker than a greased pig at a county fair. Glitches get
          stitches - ride into the sunset with Tor.
        </BodyText>
        <ButtonCTA
          onClick={() =>
        ...
        <BigAssButton onClick={() => setToggle(!toggle)}>
        ...
        <BodyText2>
          Dette er min første linje kode etter alt for mye pizza
        </BodyText2>
