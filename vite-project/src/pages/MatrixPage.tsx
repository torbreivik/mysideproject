...
const ImageCropped = styled.div`
    ...
    border-radius: 50%;
    display: block;
    background-image: url(${(props) => props.src}); /* Replace with your image path */
...
export function MatrixPage() {
    ...
    if (width < 800) {
        ...
        bodytextContent4 = "And stay a product owner for the rest of your life, believing whatever you want to believe";
        imageUrl = "/pill.png";
        circleCrop = false;
    }
    ...
    return (
        <CenterSelf>
            <MatrixRain />
            <ContentStyle>
                {circleCrop ? <ImageCropped src={imageUrl} /> : <Image src={imageUrl} />}
